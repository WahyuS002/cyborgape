...
import TeamImages from '../../public/assets/TeamImages'
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-12">
                ...
                <div className="w-full md:w-2/3">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {teams.map((person) => (
                            <div key={person.name}>
                                <Image className="w-full rounded-xl" src={person.pfp} width={500} height={500} alt="" />
                                <div className="mt-3 flex items-center justify-between">
                                    <div>
                                        <p className="font-bold">{person.name}</p>
                                        <p className="font-medium text-sm text-gray-500">{person.position}</p>
                                    </div>
